...
public final class Call extends gram.i.types.Expressao implements tom.library.sl.Visitable  {
  ...
  public static Call make(String _Id, gram.i.types.Parametros _Parametros) {

    // use the proto as a model
    gomProto.initHashCode( _Id,  _Parametros);
   ...
   */
  private void init(String _Id, gram.i.types.Parametros _Parametros, int hashCode) {
    this._Id = _Id.intern();
   ...
   * @param _Parametros
   */
  private void initHashCode(String _Id, gram.i.types.Parametros _Parametros) {
    this._Id = _Id.intern();
    this._Parametros = _Parametros;
  ...
  public shared.SharedObject duplicate() {
    Call clone = new Call();
    clone.init( _Id,  _Parametros, hashCode);
    return clone;
  }
 ...
 //shared.SharedObject
  ...
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof Call) {
      ...
      Call peer = (Call) obj;
      return _Id==peer._Id && _Parametros==peer._Parametros && true;
    }
    return false;
  }
  ...
  public gram.i.types.Expressao setId(String set_arg) {
    return make(set_arg, _Parametros);
  }
  ...
  public aterm.ATerm toATerm() {
    ...
    return atermFactory.makeAppl(
      ...
      new aterm.ATerm[] {(aterm.ATerm) atermFactory.makeAppl(atermFactory.makeAFun(getId() ,0 , true)), getParametros().toATerm()});
  }
  ...
  public static gram.i.types.Expressao fromTerm(aterm.ATerm trm, tom.library.utils.ATermConverter atConv) {
    ...
    if(trm instanceof aterm.ATermAppl) {
      ...
      if(symbolName.equals(appl.getName()) && !appl.getAFun().isQuoted()) {
        return make(
convertATermToString(appl.getArgument(0), atConv), gram.i.types.Parametros.fromTerm(appl.getArgument(1),atConv)
        );
      }
    }
    return null;
  ...
  public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable v) {
    switch(index) {
      case 0: return make(getId(), _Parametros);
      case 1: return make(getId(), (gram.i.types.Parametros) v);
  ...
  public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] childs) {
    if (childs.length == 2  && childs[0] instanceof tom.library.sl.VisitableBuiltin && childs[1] instanceof gram.i.types.Parametros) {
      return make(((tom.library.sl.VisitableBuiltin<String>)childs[0]).getBuiltin(), (gram.i.types.Parametros) childs[1]);
    } else {
  ...
  public tom.library.sl.Visitable[] getChildren() {
    return new tom.library.sl.Visitable[] {  new tom.library.sl.VisitableBuiltin<String>(_Id),  _Parametros };
  }
