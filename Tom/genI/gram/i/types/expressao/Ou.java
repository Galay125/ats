...
public final class Ou extends gram.i.types.Expressao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Ou";


  private Ou() {}
  private int hashCode;
  private static Ou gomProto = new Ou();
    private gram.i.types.Expressao _Cond1;
  private gram.i.types.Expressao _Cond2;

  /**
   * Constructor that builds a term rooted by Ou
   *
   * @return a term rooted by Ou
   */

  public static Ou make(gram.i.types.Expressao _Cond1, gram.i.types.Expressao _Cond2) {

    // use the proto as a model
    gomProto.initHashCode( _Cond1,  _Cond2);
    return (Ou) factory.build(gomProto);
   ...
   * @param  _Cond1
   * @param _Cond2
   * @param hashCode hashCode of Ou
   */
  private void init(gram.i.types.Expressao _Cond1, gram.i.types.Expressao _Cond2, int hashCode) {
    this._Cond1 = _Cond1;
    this._Cond2 = _Cond2;
   ...
   * @param _Cond2
   */
  private void initHashCode(gram.i.types.Expressao _Cond1, gram.i.types.Expressao _Cond2) {
    this._Cond1 = _Cond1;
    this._Cond2 = _Cond2;
  ...
  public shared.SharedObject duplicate() {
    Ou clone = new Ou();
    clone.init( _Cond1,  _Cond2, hashCode);
    return clone;
  }
...
buffer.append(",");
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Ou and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof Ou) {

      Ou peer = (Ou) obj;
      return _Cond1==peer._Cond1 && _Cond2==peer._Cond2 && true;
    }
    return false;
  }
   ...
   *
   * @return true, because this is rooted by Ou
   */
  @Override
  public boolean isOu() {
    return true;
  ...
  public aterm.ATerm toATerm() {
    ...
    return atermFactory.makeAppl(
      ...
      new aterm.ATerm[] {getCond1().toATerm(), getCond2().toATerm()});
  }
...
gram.i.types.Expressao.fromTerm(appl.getArgument(0),atConv), gram.i.types.Expressao.fromTerm(appl.getArgument(1),atConv)
  ...
  public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable v) {
    switch(index) {
      case 0: return make((gram.i.types.Expressao) v, _Cond2);
      case 1: return make(_Cond1, (gram.i.types.Expressao) v);
  ...
  public tom.library.sl.Visitable[] getChildren() {
    return new tom.library.sl.Visitable[] {  _Cond1,  _Cond2 };
  }
