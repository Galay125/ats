...
public final class ExpNum extends gram.i.types.Expressao implements tom.library.sl.Visitable  {
  ...
  public static ExpNum make(gram.i.types.Expressao _Exp1, gram.i.types.OpNum _op, gram.i.types.Expressao _Exp2) {
   ...
   */
  private void init(gram.i.types.Expressao _Exp1, gram.i.types.OpNum _op, gram.i.types.Expressao _Exp2, int hashCode) {
    this._Exp1 = _Exp1;
    this._op = _op;
    this._Exp2 = _Exp2;
   ...
   * @param _Exp2
   */
  private void initHashCode(gram.i.types.Expressao _Exp1, gram.i.types.OpNum _op, gram.i.types.Expressao _Exp2) {
    this._Exp1 = _Exp1;
    this._op = _op;
    this._Exp2 = _Exp2;
  ...
  public static gram.i.types.Expressao fromTerm(aterm.ATerm trm, tom.library.utils.ATermConverter atConv) {
    ...
    if(trm instanceof aterm.ATermAppl) {
      ...
      if(symbolName.equals(appl.getName()) && !appl.getAFun().isQuoted()) {
        return make(
gram.i.types.Expressao.fromTerm(appl.getArgument(0),atConv), gram.i.types.OpNum.fromTerm(appl.getArgument(1),atConv), gram.i.types.Expressao.fromTerm(appl.getArgument(2),atConv)
        );
      }
    }
    return null;
  ...
  public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable v) {
    switch(index) {
      case 0: return make((gram.i.types.Expressao) v, _op, _Exp2);
      case 1: return make(_Exp1, (gram.i.types.OpNum) v, _Exp2);
      case 2: return make(_Exp1, _op, (gram.i.types.Expressao) v);
  ...
  public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] childs) {
    if (childs.length == 3  && childs[0] instanceof gram.i.types.Expressao && childs[1] instanceof gram.i.types.OpNum && childs[2] instanceof gram.i.types.Expressao) {
      return make((gram.i.types.Expressao) childs[0], (gram.i.types.OpNum) childs[1], (gram.i.types.Expressao) childs[2]);
    } else {
