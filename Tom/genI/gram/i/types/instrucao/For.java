...
public final class For extends gram.i.types.Instrucao implements tom.library.sl.Visitable  {
  ...
  public static For make(gram.i.types.Instrucao _Declaracao, gram.i.types.Expressao _Condicao, gram.i.types.Expressao _Expressao, gram.i.types.Instrucao _Instrucao) {

    // use the proto as a model
    gomProto.initHashCode( _Declaracao,  _Condicao,  _Expressao,  _Instrucao);
   ...
   */
  private void init(gram.i.types.Instrucao _Declaracao, gram.i.types.Expressao _Condicao, gram.i.types.Expressao _Expressao, gram.i.types.Instrucao _Instrucao, int hashCode) {
   ...
   * @param _Instrucao
   */
  private void initHashCode(gram.i.types.Instrucao _Declaracao, gram.i.types.Expressao _Condicao, gram.i.types.Expressao _Expressao, gram.i.types.Instrucao _Instrucao) {
    this._Declaracao = _Declaracao;
    this._Condicao = _Condicao;
    this._Expressao = _Expressao;
    this._Instrucao = _Instrucao;
  ...
  public shared.SharedObject duplicate() {
    For clone = new For();
    clone.init( _Declaracao,  _Condicao,  _Expressao,  _Instrucao, hashCode);
    return clone;
  }
 ...
 //shared.SharedObject
  ...
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof For) {
      ...
      For peer = (For) obj;
      return _Declaracao==peer._Declaracao && _Condicao==peer._Condicao && _Expressao==peer._Expressao && _Instrucao==peer._Instrucao && true;
    }
    return false;
  }
  ...
  public gram.i.types.Instrucao setDeclaracao(gram.i.types.Instrucao set_arg) {
    return make(set_arg, _Condicao, _Expressao, _Instrucao);
  }
  ...
  public gram.i.types.Instrucao setCondicao(gram.i.types.Expressao set_arg) {
    return make(_Declaracao, set_arg, _Expressao, _Instrucao);
  }
  ...
  public gram.i.types.Instrucao setExpressao(gram.i.types.Expressao set_arg) {
    return make(_Declaracao, _Condicao, set_arg, _Instrucao);
  }
  ...
  public gram.i.types.Instrucao setInstrucao(gram.i.types.Instrucao set_arg) {
    return make(_Declaracao, _Condicao, _Expressao, set_arg);
  }
  ...
  public aterm.ATerm toATerm() {
    ...
    return atermFactory.makeAppl(
      ...
      new aterm.ATerm[] {getDeclaracao().toATerm(), getCondicao().toATerm(), getExpressao().toATerm(), getInstrucao().toATerm()});
  }
  ...
  public static gram.i.types.Instrucao fromTerm(aterm.ATerm trm, tom.library.utils.ATermConverter atConv) {
    ...
    if(trm instanceof aterm.ATermAppl) {
      ...
      if(symbolName.equals(appl.getName()) && !appl.getAFun().isQuoted()) {
        return make(
gram.i.types.Instrucao.fromTerm(appl.getArgument(0),atConv), gram.i.types.Expressao.fromTerm(appl.getArgument(1),atConv), gram.i.types.Expressao.fromTerm(appl.getArgument(2),atConv), gram.i.types.Instrucao.fromTerm(appl.getArgument(3),atConv)
        );
      }
    }
    return null;
  ...
  public tom.library.sl.Visitable getChildAt(int index) {
    switch(index) {
      case 0: return _Declaracao;
      case 1: return _Condicao;
  ...
  public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable v) {
    switch(index) {
      case 0: return make((gram.i.types.Instrucao) v, _Condicao, _Expressao, _Instrucao);
      case 1: return make(_Declaracao, (gram.i.types.Expressao) v, _Expressao, _Instrucao);
      case 2: return make(_Declaracao, _Condicao, (gram.i.types.Expressao) v, _Instrucao);
      case 3: return make(_Declaracao, _Condicao, _Expressao, (gram.i.types.Instrucao) v);
  ...
  public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] childs) {
    if (childs.length == 4  && childs[0] instanceof gram.i.types.Instrucao && childs[1] instanceof gram.i.types.Expressao && childs[2] instanceof gram.i.types.Expressao && childs[3] instanceof gram.i.types.Instrucao) {
      return make((gram.i.types.Instrucao) childs[0], (gram.i.types.Expressao) childs[1], (gram.i.types.Expressao) childs[2], (gram.i.types.Instrucao) childs[3]);
    } else {
  ...
  public tom.library.sl.Visitable[] getChildren() {
    return new tom.library.sl.Visitable[] {  _Declaracao,  _Condicao,  _Expressao,  _Instrucao };
  }
