...
public final class Decl extends gram.i.types.Declaracoes implements tom.library.sl.Visitable  {
  ...
  public static Decl make(String _Id, gram.i.types.Expressao _Expressao) {

    // use the proto as a model
    gomProto.initHashCode( _Id,  _Expressao);
   ...
   */
  private void init(String _Id, gram.i.types.Expressao _Expressao, int hashCode) {
    this._Id = _Id.intern();
   ...
   * @param _Expressao
   */
  private void initHashCode(String _Id, gram.i.types.Expressao _Expressao) {
    this._Id = _Id.intern();
    this._Expressao = _Expressao;
  ...
  public shared.SharedObject duplicate() {
    Decl clone = new Decl();
    clone.init( _Id,  _Expressao, hashCode);
    return clone;
  }
 ...
 //shared.SharedObject
  ...
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof Decl) {
      ...
      Decl peer = (Decl) obj;
      return _Id==peer._Id && _Expressao==peer._Expressao && true;
    }
    return false;
  }
   ...
   */
  @Override
  public gram.i.types.Declaracoes setId(String set_arg) {
    return make(set_arg, _Expressao);
  }
   ...
   */
  @Override
  public gram.i.types.Declaracoes setExpressao(gram.i.types.Expressao set_arg) {
  ...
  public aterm.ATerm toATerm() {
    ...
    return atermFactory.makeAppl(
      ...
      new aterm.ATerm[] {(aterm.ATerm) atermFactory.makeAppl(atermFactory.makeAFun(getId() ,0 , true)), getExpressao().toATerm()});
  }
  ...
  public static gram.i.types.Declaracoes fromTerm(aterm.ATerm trm, tom.library.utils.ATermConverter atConv) {
    ...
    if(trm instanceof aterm.ATermAppl) {
      ...
      if(symbolName.equals(appl.getName()) && !appl.getAFun().isQuoted()) {
        return make(
convertATermToString(appl.getArgument(0), atConv), gram.i.types.Expressao.fromTerm(appl.getArgument(1),atConv)
        );
      }
    }
    return null;
  ...
  public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable v) {
    switch(index) {
      case 0: return make(getId(), _Expressao);
      case 1: return make(getId(), (gram.i.types.Expressao) v);
  ...
  public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] childs) {
    if (childs.length == 2  && childs[0] instanceof tom.library.sl.VisitableBuiltin && childs[1] instanceof gram.i.types.Expressao) {
      return make(((tom.library.sl.VisitableBuiltin<String>)childs[0]).getBuiltin(), (gram.i.types.Expressao) childs[1]);
    } else {
  ...
  public tom.library.sl.Visitable[] getChildren() {
    return new tom.library.sl.Visitable[] {  new tom.library.sl.VisitableBuiltin<String>(_Id),  _Expressao };
  }
