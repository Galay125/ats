...
public final class Argumento extends gram.i.types.Argumentos implements tom.library.sl.Visitable  {
  ...
  public static Argumento make(gram.i.types.DefTipo _DefTipo, String _Id) {

    // use the proto as a model
    gomProto.initHashCode( _DefTipo,  _Id);
   ...
   */
  private void init(gram.i.types.DefTipo _DefTipo, String _Id, int hashCode) {
   ...
   * @param _Id
   */
  private void initHashCode(gram.i.types.DefTipo _DefTipo, String _Id) {
    this._DefTipo = _DefTipo;
    this._Id = _Id.intern();
  ...
  public shared.SharedObject duplicate() {
    ...
    clone.init( _DefTipo,  _Id, hashCode);
    return clone;
  }
 ...
 //shared.SharedObject
  ...
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof Argumento) {
      ...
      return _DefTipo==peer._DefTipo && _Id==peer._Id && true;
    }
    return false;
  }
  ...
  public aterm.ATerm toATerm() {
    ...
    return atermFactory.makeAppl(
      ...
      new aterm.ATerm[] {getDefTipo().toATerm(), (aterm.ATerm) atermFactory.makeAppl(atermFactory.makeAFun(getId() ,0 , true))});
  }
  ...
  public static gram.i.types.Argumentos fromTerm(aterm.ATerm trm, tom.library.utils.ATermConverter atConv) {
    ...
    if(trm instanceof aterm.ATermAppl) {
      ...
      if(symbolName.equals(appl.getName()) && !appl.getAFun().isQuoted()) {
        return make(
gram.i.types.DefTipo.fromTerm(appl.getArgument(0),atConv), convertATermToString(appl.getArgument(1), atConv)
        );
      }
    }
    return null;
  ...
  public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable v) {
    switch(index) {
      case 0: return make((gram.i.types.DefTipo) v, getId());
      case 1: return make(_DefTipo, getId());
  ...
  public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] childs) {
    if (childs.length == 2  && childs[0] instanceof gram.i.types.DefTipo && childs[1] instanceof tom.library.sl.VisitableBuiltin) {
      return make((gram.i.types.DefTipo) childs[0], ((tom.library.sl.VisitableBuiltin<String>)childs[1]).getBuiltin());
    } else {
  ...
  public tom.library.sl.Visitable[] getChildren() {
    return new tom.library.sl.Visitable[] {  _DefTipo,  new tom.library.sl.VisitableBuiltin<String>(_Id) };
  }
